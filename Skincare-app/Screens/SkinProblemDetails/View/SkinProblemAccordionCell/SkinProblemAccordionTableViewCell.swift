//
//  SkinProblemAccordionTableViewCell.swift
//  Skincare-app
//
...
protocol SkinProblemAccordionTableViewCellDelegate: AnyObject {
    func didTapAccordionButton(in cell: SkinProblemAccordionTableViewCell)
}

class SkinProblemAccordionTableViewCell: UITableViewCell {
    private var isExpanded: Bool = false
    weak var delegate: SkinProblemAccordionTableViewCellDelegate?
    ...
    func configure(_ item: SkinProblemDetailsModel.Information){
